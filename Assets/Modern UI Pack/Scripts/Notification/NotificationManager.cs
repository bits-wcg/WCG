    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (useStacking == true)
            {
                try
                {
                    var stacking = transform.GetComponentInParent<NotificationStacking>();
        ...
        public void OpenNotification()
        {
            ...
            StopCoroutine(nameof(DisableNotification));

            notificationAnimator.Play("In");
            onOpen.Invoke();

            if (enableTimer == true) { StartCoroutine(nameof(StartTimer)); }
        }
        ...
        public void CloseNotification()
        {
            ...
            StartCoroutine(nameof(DisableNotification));
        }
